...
ROLE_TEMPLATES: dict[AgentRole, dict] = {
    ...
    AgentRole.BACKEND_DEV: {
        ...
        "can_write_to": ["/backend", "/api", "/server", "/src/api", "apps/api", "/docs"],
        "can_read": ["/docs", "/"],
    ...
    AgentRole.DATA_ENGINEER: {
        ...
        "tools": ["file_read", "file_write", "run_command", "web_search"],
        "can_write_to": ["/backend", "/migrations", "/data", "/db", "apps/api", "/docs"],
        "can_read": ["/docs", "/"],
        "allow_delegation": False,
    },
    AgentRole.AI_ENGINEER: {
        ...
        "tools": ["file_read", "file_write", "run_command", "web_search"],
        "can_write_to": ["/backend", "/ai", "/src/ai", "/ml", "apps/api", "/docs"],
        "can_read": ["/docs", "/"],
        "allow_delegation": False,
    },
    AgentRole.TESTER: {
