...
def _monorepo_write_scopes(role: AgentRole) -> list[str]:
    ...
    scopes: dict[AgentRole, list[str]] = {
        ...
        AgentRole.BACKEND_DEV: ["apps/api", "apps/api/.env.example", "packages/shared", "packages/database"],
        AgentRole.FRONTEND_DEV: ["apps/mobile", "apps/admin", "packages/ui", "packages/shared"],
